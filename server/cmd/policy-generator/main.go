...
import (
	...
	accountsrbac "github.com/reearth/reearth-accounts/server/internal/reearth-accounts/rbac"
...
func main() {
	sets := []policySet{
		{accountsrbac.ServiceName, accountsrbac.DefineResources, accountsrbac.PolicyFileDir},
