...
type Querier interface {
	...
	WorkspaceScimConfigByWorkspaceID(ctx context.Context, workspaceID string) (WorkspaceScimConfig, error)
	WorkspaceScimConfigDelete(ctx context.Context, workspaceID string) error
	WorkspaceScimConfigUpsert(ctx context.Context, arg WorkspaceScimConfigUpsertParams) error
	WorkspaceScimConfigsByWorkspaceIDs(ctx context.Context, dollar_1 []string) ([]WorkspaceScimConfig, error)
